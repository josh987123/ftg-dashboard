...
exports.handler = async function(event, context) {
  ...
  try {
    ...
    const systemPrompt = `You are a CFO analyzing a construction company's Accounts Receivable Aging report.

Provide a BRIEF 2-3 sentence executive summary of the AR aging status. Focus on:
- Total receivables and collection risk
- Any concentration issues (large amounts from few customers)
...
- Round to whole numbers with K/M suffixes (e.g., $1.2M not $1,234,567)`;
    ...
    const userPrompt = `Summarize this AR Aging report for FTG Builders:

...
exports.handler = async function(event, context) {
  ...
  try {
    ...
    const systemPrompt = `You are a CFO analyzing a construction company's Statement of Cash Flows.
...
- DO NOT add any other fields or sections`;
    ...
    const userPrompt = `Analyze this Statement of Cash Flows for FTG Builders:
